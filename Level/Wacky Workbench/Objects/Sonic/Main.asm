...
SaveTimeWarpData:				; Save some values
	...
	bclr	#3,warpPlayerFlags			; Don't be marked as standing on an object
	bclr	#6,warpPlayerFlags			; Don't be marked as being underwater
...
ObjSonic_TimeWarp:
	cmpi.w	#0,zone			; Are we in Palmtree Panic act 1?
...
ObjSonic_Restart:
	...
	bsr.w	ResetSavedObjFlags		; Reset the respawn table
