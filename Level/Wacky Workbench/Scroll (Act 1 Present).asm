...
DrawLevel:
	...
	lea	lvlScrollFlagsCopy+2,a2		; Update background section 1
	lea	lvlCamXBgCopy,a3
	lea	levelLayout+$40.w,a4
	move.w	#$6000,d2
	bsr.w	DrawLevelBG1

	lea	lvlScrollFlagsCopy+4,a2		; Update background section 2
	lea	lvlCamXBg2Copy,a3
	bsr.w	DrawLevelBG2

	lea	lvlScrollFlagsCopy+6,a2		; Update background section 3
